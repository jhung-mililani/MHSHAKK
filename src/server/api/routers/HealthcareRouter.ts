...
const InsuranceValidator = z.union([z.literal("FQHC"), z.literal("QI"), z.undefined()]);
const ProcedureValidator = z.union([z.literal("Comprehensive Care"), z.literal("Obstetrician and Gynecologist"), z.literal("Internal Medicine"), z.literal("RN Family Nurse Practitioner"), z.literal("Family Medicine"), z.literal("Pediatrician"), z.literal("Podiatrist"), z.literal("Nephrologist"), z.undefined()]);
...
const HealthcareRouter = createTRPCRouter({
  ...
  getByPlan: publicProcedure
    ...
    .query(async ({ input }) => {
      ...
      }) : await db.healthCenter.findMany();
