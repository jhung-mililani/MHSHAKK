        ...
        <>
            ...
            <div className="font-tyler">
                ...
                <div className="flex flex-co mb-10 pt-14">
                    <div className="px-5 md:px-0 md:pl-60 md:pr-2 justify-center">
                        <h1 className="text-3xl  font-semibold text-center md:text-left">Finding a Clinic</h1>
                        ...
                        <h1 className="text-3xl  font-semibold pt-8 text-center md:text-left">What is Med-QUEST?</h1>
                    ...
                    <div className="w-1/2 hidden md:block">
                        <img className="md:h-full w-3/4 object-cover h-1 w-1" src="https://images.unsplash.com/photo-1591068929753-4d1cf8fc6ff7?auto=format&fit=crop&q=80&w=1932&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"></img>
                    </div>
                </div>
            </div>
            <Footer/>
