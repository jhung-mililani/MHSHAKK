    ...
    return (
        <>
            ...
            <div className="font-tyler">
                <div className="h-100 w-screen bg-dark-blue font-tyler text-center sm:text-left">
                    <div className="mx-[calc(10%)] sm:mx-0 px-2 sm:px-0 ml-0 sm:ml-60 pt-14 w-full sm:w-2/3">
                        <h1 className="text-white text-6xl font-bold">Tyler Healthcare Hawaii</h1>
                        <p className="text-white text-2xl sm:text-3xl mt-6 font-semi-bold">Healthcare clinic finder for the uninsured and underinsured</p>
                ...
                <div className="flex flex-co mb-10 pt-7 sm:pt-14">
                    <div className="px-5 sm:px-0 sm:pl-60 sm:pr-2 justify-center">
                        <h1 className="text-4xl  font-semibold text-center sm:text-left">Finding a Clinic</h1>
                        ...
                        <h1 className="text-4xl  font-semibold pt-8 text-center sm:text-left">What is Med-QUEST?</h1>
                    ...
                    <div className="w-1/2 hidden sm:block">
                        <Image className="sm:h-full w-3/4 object-cover h-1" loading="eager" width={1280} height={720} alt="Image of Hawaii" src={islandImage}/>
                    </div>
                </div>
            </div>
            <Footer />
