            ...
            <div className="font-tyler">
                ...
                <div className="flex flex-co mb-10 pt-14">
                    <div className="px-5 sm:px-0 sm:pl-60 sm:pr-2 justify-center">
                        <h1 className="text-3xl  font-semibold text-center sm:text-left">Finding a Clinic</h1>
                        ...
                        <h1 className="text-3xl  font-semibold pt-8 text-center sm:text-left">What is Med-QUEST?</h1>
